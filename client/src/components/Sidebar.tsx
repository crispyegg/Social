    ...
    >
        ...
        {navItems.map((item) => {
          ...
          return (
            <NavLink
              ...
              className={`flex items-center gap-3 py-2.5 rounded text-sm transition-all duration-150 border ${isActive ? "bg-red-50 border-red-200 text-red-500" : "text-slate-500 hover:bg-slate-50 border-transparent hover:text-slate-700"}`}
            >
              <item.icon
      ...
      <div className="p-4 border-t border-slate-100">
        <div className="flex items-center gap-3 p-2 rounded-xl hover:bg-slate-50 transition-colors">
          <div className="size-8 rounded-full bg-linear-to-br from-red-400 to bg-pink-400 flex items-center justify-center text-white text-sm front-medium shrink-0">
         ...
         <button className="mt-1 flex items-center gap-2 px-3 py-2 w-full rounded  text-sm text-slate-500 hover:bg-red-50 hover:text-red-600 transition-all" onClick={logout}>
